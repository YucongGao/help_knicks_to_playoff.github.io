...
```{r, include=FALSE}
add_season = function(seasons_id, seasons_year, file) {
  nba_stat_df = read_csv(file)
  nba_stat_df = 
    nba_stat_df %>% 
    mutate(season_id = seasons_id, 
           season_year = seasons_year) %>% 
    relocate(season_id, season_year)
  
  return(nba_stat_df)
}

seasons_id = 
  c(replicate(30, "22020"), 
  replicate(30, "22019"), 
  replicate(30, "22018"), 
  replicate(30, "22017"), 
  replicate(30, "22016"), 
...
defensive_impact_df = add_season(seasons_id, seasons_year, "./data/defensive_impact_12_21.csv")

passing_df = add_season(seasons_id, seasons_year, "./data/passing_12_21.csv") 
touches_df = add_season(seasons_id, seasons_year, "./data/touches_12_21.csv")
drive_df = add_season(seasons_id, seasons_year, "./data/drives_12_21.csv")
...
pullup_shooting_df = add_season(seasons_id_12_20, seasons_year_12_20, "./data/pullup_shooting_12_21.csv") 
catch_and_shoot_df = add_season(seasons_id_12_20, seasons_year_12_20, "./data/catch_and_shoot_12_21.csv")
isolation_df = add_season(seasons_id_12_20, seasons_year_12_20, "./data/isolation_12_21.csv")
pick_roll_baller_df = add_season(seasons_id_12_20, seasons_year_12_20, "./data/prbh_12_21.csv")
pick_roll_roller_df = add_season(seasons_id_12_20, seasons_year_12_20, "./data/prrm_12_21.csv")
transition_df = add_season(seasons_id_12_20, seasons_year_12_20, "./data/transition_12_21.csv")
